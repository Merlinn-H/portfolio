...
const services = [
  {
    ...
    title: "Réalisation",
    description:
      "Courts-métrages, clips musicaux, documentaires. Conception et réalisation de vos projets de A à Z.",
  },
  {
    number: "02",
    title: "Production",
    description:
      "Production audiovisuelle et podcasts. Gestion complète du projet, du budget au rendu final.",
  },
  {
    number: "03",
    title: "Conseil",
    description:
      "Accompagnement et conseil en production audiovisuelle. On vous guide à chaque étape de votre projet.",
  },
];
  ...
  return (
    ...
    >
      {Array.from({ length: 24 }).map((_, i) => (
        <div
          key={i}
          className="w-4 h-3 border border-white/50 mx-auto rounded-[2px]"
        />
      ))}
    </div>
  );
  ...
  return (
    ...
    >
      ...
      <div ref={ref} className="relative z-20 px-8 max-w-5xl mx-auto">
        ...
        >
          Studio de production audiovisuelle basé à Montpellier. Nous
          accompagnons artistes, marques et porteurs de projets de la première
          idée jusqu'à la livraison finale.
        </motion.p>
